...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    @if($isPending)
    {{-- Quote is still valid and pending --}}
    <div class="card p-6 space-y-4">
        ...
        <form action="{{ route('courier.requests.accept-quote', $request->id) }}" method="POST">
            @csrf
            <button type="submit"
                onclick="return confirm('Accept this price quote and confirm your assignment for request #{{ $request->request_number }}? Your earnings will be ${{ number_format($quote->courier_fee, 2) }}.')"
        ...
        {{-- Decline toggle --}}
        <div>
            <button type="button" onclick="document.getElementById('declineSection').classList.toggle('hidden')"
            ...
            <div id="declineSection" class="hidden mt-4 p-5 bg-red-50 border border-red-200 rounded-lg">
                ...
                <p class="text-sm text-red-600 mb-4">
                    Declining will remove you from this assignment. Admin will be notified and can reassign to another courier.
                </p>
                ...
                <form action="{{ route('courier.requests.decline-quote', $request->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="reason" rows="3" required minlength="10" maxlength="500"
                            ...
                            placeholder="Please explain why you are declining this assignment (minimum 10 characters)..."></textarea>
                        @error('reason')
                    ...
                    <div class="flex gap-3">
                        ...
                        <button type="submit"
                            onclick="return confirm('Are you sure you want to decline this assignment? This cannot be undone.')"
    ...
    <div class="card p-6 text-center bg-red-50 border border-red-200">
        ...
        @endif
        <p class="text-gray-600 text-sm mt-4">Admin has been notified and will reassign the request.</p>
    ...
    <div class="card p-6 text-center bg-gray-100 border border-gray-300">
        ...
        <h3 class="font-bold text-gray-700 text-xl">Quote Expired</h3>
