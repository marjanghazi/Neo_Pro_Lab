...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div class="space-y-4 md:space-y-6">
            ...
            <!-- Performance Stats -->
            <div class="card p-4 md:p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 md:mb-6 gap-1">
                    <h3 class="text-base md:text-lg font-bold">Your Performance</h3>
                    <span class="text-xs md:text-sm text-gray-500 whitespace-nowrap">This Month</span>
                </div>
                ...
                <div class="space-y-3 md:space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex">
                            @for($i = 1; $i <= 5; $i++)
                                <i class="fas fa-star {{ $i <= $customerRating ? 'text-yellow-500' : 'text-gray-300' }} text-xs md:text-sm mr-1"></i>
                                @endfor
                        </div>
                    </div>
                ...
                <div class="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-gray-200">
                    <div class="flex items-center justify-center">
                        <div class="text-center">
                            <div class="text-xl md:text-2xl font-bold text-teal-600">{{ $stats['completed'] }}</div>
                            <div class="text-xs text-gray-500">Total Completed</div>
                        </div>
                        <div class="mx-4 md:mx-8 text-gray-300">|</div>
                        <div class="text-center">
                            <div class="text-xl md:text-2xl font-bold text-blue-600">{{ $stats['in_progress'] }}</div>
