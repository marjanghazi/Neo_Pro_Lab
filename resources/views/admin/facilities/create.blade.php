...
<div class="card p-6">
    <div class="mb-6">
        <h2 class="text-lg font-bold text-gray-800">Register New Healthcare Facility</h2>
        <p class="text-sm text-gray-600">Fill in the facility details to register a new healthcare facility in the system</p>
    </div>
    ...
    <form action="{{ route('admin.facilities.store') }}" method="POST" class="space-y-6">
        ...
        <div class="section-card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Country Field (add this to address section) -->
                <div>
