...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="card p-6">
        <h2 class="text-lg font-bold mb-6">Orders by Status</h2>
        <div id="ordersByStatusChart" style="min-height: 300px;"></div>
    </div>
</div>
    ...
    <div class="space-y-4">
        ...
        <div class="flex items-start space-x-3 p-3 hover:bg-gray-50 rounded-lg">
            <div class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0">
                <i class="fas fa-{{ $this->getActivityIcon($activity->action) }} text-gray-600"></i>
            </div>
            <div class="flex-1">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const ordersByStatusData = @json($requestsByStatus);
        
        const labels = Object.keys(ordersByStatusData);
        const data = Object.values(ordersByStatusData);
        ...
        const chart = new ApexCharts(document.querySelector("#ordersByStatusChart"), options);
        chart.render();
    });
</script>
@endpush
