...
<body>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <span class="courier-status status-online mr-2">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="navbar">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <!-- Location Status -->
                        <div class="hidden md:flex items-center space-x-2 px-3 py-2 bg-green-50 rounded-lg">
                            <span class="status-dot bg-green-500"></span>
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="border-t border-gray-200">
                                    <a href="#" class="dropdown-item text-center text-teal-600 font-medium">
    ...
    <script>
        ...
        // Auto location update for couriers
        ...
        // Update location every 30 seconds if courier is logged in
        if (document.body.classList.contains('courier-layout')) {
            setInterval(updateCourierLocation, 30000);
            // Initial update after 5 seconds
            setTimeout(updateCourierLocation, 5000);
        }
    </script>
