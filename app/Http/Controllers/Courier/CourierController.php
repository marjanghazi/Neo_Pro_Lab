...
class CourierController extends Controller
{
    ...
    public function acceptAssignment(Request $request, SpecimenRequest $specimenRequest)
    {
        ...
        if ($specimenRequest->courier_id != Auth::id()) {
        ...
        AuditLog::create([
            ...
            'description' => "Accepted assignment #{$specimenRequest->request_number}",
    ...
    private function startLocationTracking(SpecimenRequest $request)
    {
        ...
        cache()->put("courier_online_{$request->courier_id}", true, now()->addHours(24));
    }
